...
export async function createTestSession(options = {}) {
    ...
    // The session validates via _modelRegistry.getApiKeyAndHeaders — patch it
    // (getApiKey was renamed to getApiKeyAndHeaders in @earendil-works/pi-coding-agent >= 0.75)
    ...
    const testSession = {
        ...
        async run(...turns) {
            ...
            // Compat shim: setTools was refactored to state.tools in @earendil-works/pi-coding-agent ≥ 0.75
            if (typeof session.agent.setTools === "function") {
