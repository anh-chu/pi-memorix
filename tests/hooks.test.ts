...
describe("before_agent_start → UserPromptSubmit", () => {
	...
	it("does not inject UserPromptSubmit result into systemPrompt (fire-and-forget)", async () => {
		...
		// UserPromptSubmit is fire-and-forget — result is NOT injected into systemPrompt
